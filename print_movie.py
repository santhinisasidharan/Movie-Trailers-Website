# This module create instances to class Movie
# Movie related data is given to fresh_tomatoes.py

import movie
import fresh_tomatoes

'''
Input the Movie class parameters :
                            Title
                            storyline
                            Poster URL
                            Youtube URL '''

toystory = movie.Movie(
                        "Toystory",
                        "Andy's favourite toy, Woody, is worried that "
                       "after Andy receives his birthday gift, a new toy called "
                       "Buzz Lightyear, his importance may get reduced.",
                       "http://www.gstatic.com/tv/thumb/movieposters/17420/p17420_p_v8_ab.jpg",
                       "https://www.youtube.com/watch?v=KYz2wyBy3kc"  
                        )  #NOQA
#toystory.show_Trailer()

hidden_figures = movie.Movie(
                            "Hidden Figures",
                            "The story of a team of African-American women mathematicians who "
                            "served a vital role in NASA during the early years of the US space program.",
...
beauty_and_beast = movie.Movie(
                                "Beauty and the beast",
                                "An adaptation of the Disney fairy tale about a monstrous-looking "
...
logan = movie.Movie(
                    "Logan",
                    "Logan's attempts to hide from the world and his legacy are upended"
...
kong = movie.Movie(
                    ...
                    "the domain of the mighty Kong, and must fight to escape a primal Eden.",
...
movies_list = [
                toystory, hidden_figures, beauty_and_beast,
                logan, kong, lalaland
                ]  # Make a list of movies

fresh_tomatoes.open_movies_page(
                                movies_list
                                )  # Open the movie trailers website
